              ...
              {user ? (
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-300 text-sm font-medium truncate max-w-[100px]">{user.name}</span>
                  </div>
                  <button onClick={handleLogoutClick} className="border border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white px-4 lg:px-5 py-2 rounded-full transition-all duration-300 text-sm font-medium whitespace-nowrap">
                    Logout
                  </button>
                </>
              ) : (
              ...
              {user ? (
                <>
                  <div className="flex items-center gap-3 px-1 pb-2">
                    ...
                    <span className="text-gray-300 font-medium truncate">{user.name}</span>
                  </div>
                  <button onClick={handleLogoutClick} className="block w-full text-center border border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-white px-5 py-3 rounded-md transition-all duration-300 font-medium">
                    Logout
                  </button>
                </>
              ) : (
